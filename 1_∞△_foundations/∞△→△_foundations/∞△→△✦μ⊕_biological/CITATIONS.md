---
title: "Citations - Foundations / Biological"
...
file_path: "∞_ucc/1_∞△_foundations/∞△→△_foundations/∞△→△✦μ⊕_biological/CITATIONS.md"
...
# Citations — Foundations / Biological
...
- `∞_ucc/1_∞△_foundations/∞△→△_foundations/∞△→△⤢≈τ_atmosphere/` — Radiative and chemical continuity.  
- `∞_ucc/1_∞△_foundations/∞△→△_foundations/∞△→△≈Στ_thermodynamics/` — Metabolic delay laws.  
- `∞_ucc/1_∞△_foundations/∞△→△_foundations/∞△→△✦⊕μ_neurological/` — Cognitive recursion tests.  
- `∞_ucc/1_∞△_foundations/∞△→△_foundations/∞△→△⋱_verification/` — Empirical τ–μ dataset calibration.
...
**End of File — `∞_ucc/1_∞△_foundations/∞△→△_foundations/∞△→△✦μ⊕_biological/CITATIONS.md`**  
**Seal:** ⧖↔Σ⊕ | Յ† | ❖ ✧
